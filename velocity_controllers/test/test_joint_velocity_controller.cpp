...
using CallbackReturn = velocity_controllers::JointVelocityController::CallbackReturn;
...
{
  const auto result = controller_->init(test_robot_, "test_joint_velocity_controller");
