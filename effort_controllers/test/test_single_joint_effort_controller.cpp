...
#include "test_single_joint_effort_controller.hpp"
#include "test_robot_hardware/test_robot_hardware.hpp"

using CallbackReturn = effort_controllers::SingleJointEffortController::CallbackReturn;

void SingleJointEffortControllerTest::SetUpTestCase()
{
  rclcpp::init(0, nullptr);
}

void SingleJointEffortControllerTest::TearDownTestCase()
{
  rclcpp::shutdown();
}

void SingleJointEffortControllerTest::SetUp()
{
  // initialize robot
  ...
  controller_ = std::make_unique<FriendSingleJointEffortController>();
}

void SingleJointEffortControllerTest::TearDown()
{
  controller_.reset(nullptr);
}

void SingleJointEffortControllerTest::SetUpController()
{
  const auto result = controller_->init(test_robot_, "test_single_joint_effort_controller");
  ASSERT_EQ(result, controller_interface::return_type::SUCCESS);
}

void SingleJointEffortControllerTest::SetUpHandles()
{
...
TEST_F(SingleJointEffortControllerTest, ConfigureParamsTest)
{
...
TEST_F(SingleJointEffortControllerTest, CheckParamsTest)
{
  // joint handle not initialized yet
  ASSERT_FALSE(controller_->joint_cmd_handle_);
...
TEST_F(SingleJointEffortControllerTest, StopJointOnDeactivateTest)
{
  SetUpController();
  SetUpHandles();
