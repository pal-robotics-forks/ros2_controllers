...
{
using CallbackReturn = SingleJointEffortController::CallbackReturn;

SingleJointEffortController::SingleJointEffortController()
: forward_command_controller::SingleForwardCommandController()
{
  logger_name_ = kSJPCLoggerName;
}

CallbackReturn SingleJointEffortController::on_configure(
...
CallbackReturn SingleJointEffortController::on_deactivate(
  const rclcpp_lifecycle::State & previous_state)
{
...
PLUGINLIB_EXPORT_CLASS(
  effort_controllers::SingleJointEffortController, controller_interface::ControllerInterface)
