...
using CallbackReturn = position_controllers::SingleJointPositionController::CallbackReturn;
...
TEST_F(SingleJointPositionControllerTest, ConfigureParamsTest)
{
...
TEST_F(SingleJointPositionControllerTest, CheckParamsTest)
{
  // joint handle not initialized yet
  ASSERT_FALSE(controller_->joint_cmd_handle_);
