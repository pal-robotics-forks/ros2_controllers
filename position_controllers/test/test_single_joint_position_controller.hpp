...
#ifndef TEST_SINGLE_JOINT_POSITION_CONTROLLER_HPP_
#define TEST_SINGLE_JOINT_POSITION_CONTROLLER_HPP_
...
class FriendSingleJointPositionController : public position_controllers::
  SingleJointPositionController
{
  FRIEND_TEST(SingleJointPositionControllerTest, ConfigureParamsTest);
  FRIEND_TEST(SingleJointPositionControllerTest, CheckParamsTest);
};
